...
export default function AppLayout({ children, user }: Props) {
  ...
  return (
    <div style={{ display:'flex', height:'100dvh', overflow:'hidden', background:'var(--gray)' }}>
      ...
      <aside className="app-sidebar-desktop" style={{ width:'var(--sidebar-w)', minWidth:'var(--sidebar-w)', background:'var(--dark)', flexShrink:0 }}>
        <SidebarContent/>
      </aside>
      {sideOpen && (
        <>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden', minWidth:0 }}>
        <header className="app-mobile-header" style={{ background:'var(--dark)', padding:'0 14px', height:'var(--topbar-h)', alignItems:'center', gap:12, flexShrink:0, zIndex:10 }}>
        ...
        <main className="app-main" style={{ flex:1, overflowY:'auto', padding:'var(--content-p)' }}>
          {children}
        </main>
      </div>
